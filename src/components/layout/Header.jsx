...
export default function Header() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-[color:var(--border)] bg-white/60 backdrop-blur-xl" style={{ WebkitTransform: 'translateZ(0)', transform: 'translateZ(0)' }}>
      <Container>
